const produtos = [
    ...
    { nome: "Achocolatado em Pó 3 Corações 300g", preco: 6.59, categoria: "O básico", nomeImagem: "Achocolatado em Pó 3 Corações 300g" + ".png" },
    ...
    { nome: "Frango a passarinho seara 1kg", preco: 17.40, categoria: "Carnes, Frangos e Frios", nomeImagem: "Frango a passarinho seara 1kg" + ".png" },
    ...
    { nome: "Bebida Láctea sabor Chocolate 180ml - Nescau", preco: 2.90, categoria: "Lanchinhos", nomeImagem: "Bebida Láctea sabor Chocolate 180ml - Nescau" + ".png" },
    { nome: "Oreo 90g (8 biscoitos)", preco: 4.89, categoria: "Lanchinhos", nomeImagem: "Oreo 90g (8 biscoitos)" + ".png" },
    { nome: "Água de coco sococo 200ml", preco: 3.49, categoria: "Lanchinhos", nomeImagem: "Água de coco sococo 200ml" + ".png" },
    { nome: "Guaraná jesus lata", preco: 4.20, categoria: "Bebidas e refrigerantes", nomeImagem: "Guaraná jesus lata" + ".png" },
    { nome: "Atum pedaços em óleo robinson crusoe", preco: 10.00, categoria: "O básico", nomeImagem: "Atum pedaços em óleo robinson crusoe" + ".png" },
